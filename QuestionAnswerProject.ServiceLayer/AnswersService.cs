...
using System.Linq;
using QuestionAnswerProject.DomainModel;
using QuestionAnswerProject.Repositories;
using QuestionAnswerProject.ViewModels;
using AutoMapper;

namespace QuestionAnswerProject.ServiceLayer
{
